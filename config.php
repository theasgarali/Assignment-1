...
define('DB_PASSWORD', '');  //leave blank.
define('DB_DATABASE', 'moviedb');   //database name where all data will be saved and fetched for the site.

define('STORAGE_PATH', 'assets'); // Path of the .CSS .JS and images.

define('ADMIN_EMAIL', 'noreply@moviesite.com'); //admin email added.